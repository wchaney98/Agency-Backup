...
namespace SplatterSystem {
	...
	public class SplatterSettingsEditor : Editor {
		...
		public override void OnInspectorGUI() {
			...
			EditorGUI.indentLevel++;
			if (s.directionMode != DirectionMode.AllDirections2D && s.directionMode != DirectionMode.AllDirections3D) {
				...
				ShowHint("Splatter is done in all 360 degrees. Use 2D mode for 2D games and 3D version for 3D, 2.5D " +
						 "and isometric games.");
			}
			EditorGUI.indentLevel--;
